...
ax0.plot(first_segment_left["point_order"], first_segment_left["geometry"].z, "C0.", markersize=12)
ax0.legend(("Left profile"), loc="lower right")
ax0.set_title("Left")

ax1.plot(first_segment_right["point_order"], first_segment_right["geometry"].z, "C0.", markersize=12)
